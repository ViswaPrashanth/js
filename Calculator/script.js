//select the upper elements using queryselector for showing result and also the expression given by the user.
...
function pressEqual(){
    ...
    try{
        result = eval(exp);
        //if decimal number is more than 4 decimal places
...
//Adding event listeners for keyboard buttons
